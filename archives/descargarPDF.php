...
if ($result->num_rows > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<br>";
        echo "<br>" . $row['nombre'] . "</center>";
        echo "<br>" . $row['clave'] . "</center>";
        echo "<br>" . $row['telefono'] . "</center>";
        echo "<br>" . $row['fecha'] . "</center>";
        echo "<br>" . $row['id'] . "</center>";
        echo "<br>" . $row['hora'] . "</center>";
        echo "<br>" . $row['area'] . "</center>";
        echo "<br>" . $row['estudio'] . "</center>";
    }
