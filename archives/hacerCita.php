            ...
            <form class="needs-validation" novalidate action="#" method="post" id="insertar_cita">
                ...
                <div class="form-floating mb-5">
                    <input class="form-control form-control-lg" type="tel" id="telefono" name="telefono"
                        pattern="[0-9]{10,}" placeholder="123-456-7890" required>
                ...
                <div class="form-floating mb-5">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" type="date" id="fechaCita" name="fechaCita" oninput="usarTodo()"
                                required>
                            <div class="valid-tooltip">
                                Correcto
                            </div>
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" style="height: 50%;" id="horaCita" name="horaCita"></select>
                            <div class="invalid-tooltip">
                                Elija la hora
                            </div>
                        </div>
